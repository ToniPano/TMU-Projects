...
// 
// Generated using ACDS version 14.0 209 at 2022.02.18.15:46:01
...
module soc_system_mm_interconnect_0 (
	...
	wire  [114:0] sw_pio_s1_agent_rf_source_data;                             // sw_pio_s1_agent:rf_source_data -> sw_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [114:0] sw_pio_s1_agent_rsp_fifo_out_data;                          // sw_pio_s1_agent_rsp_fifo:out_data -> sw_pio_s1_agent:rf_sink_data
	...
	wire          sw_pio_s1_agent_rdata_fifo_out_valid;                       // sw_pio_s1_agent_rdata_fifo:out_valid -> sw_pio_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] sw_pio_s1_agent_rdata_fifo_out_data;                        // sw_pio_s1_agent_rdata_fifo:out_data -> sw_pio_s1_agent:rdata_fifo_sink_data
	wire          sw_pio_s1_agent_rdata_fifo_out_ready;                       // sw_pio_s1_agent:rdata_fifo_sink_ready -> sw_pio_s1_agent_rdata_fifo:out_ready
	...
	wire          sw_pio_s1_agent_rp_endofpacket;                             // sw_pio_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	wire          sw_pio_s1_agent_rp_valid;                                   // sw_pio_s1_agent:rp_valid -> router_004:sink_valid
	wire          sw_pio_s1_agent_rp_startofpacket;                           // sw_pio_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire  [113:0] sw_pio_s1_agent_rp_data;                                    // sw_pio_s1_agent:rp_data -> router_004:sink_data
	wire          sw_pio_s1_agent_rp_ready;                                   // router_004:sink_ready -> sw_pio_s1_agent:rp_ready
	...
	wire          cmd_mux_002_src_endofpacket;                                // cmd_mux_002:src_endofpacket -> sw_pio_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_002_src_valid;                                      // cmd_mux_002:src_valid -> sw_pio_s1_burst_adapter:sink0_valid
	wire          cmd_mux_002_src_startofpacket;                              // cmd_mux_002:src_startofpacket -> sw_pio_s1_burst_adapter:sink0_startofpacket
	wire  [113:0] cmd_mux_002_src_data;                                       // cmd_mux_002:src_data -> sw_pio_s1_burst_adapter:sink0_data
	wire    [2:0] cmd_mux_002_src_channel;                                    // cmd_mux_002:src_channel -> sw_pio_s1_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_ready;                                      // sw_pio_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	...
	wire  [113:0] sw_pio_s1_burst_adapter_source0_data;                       // sw_pio_s1_burst_adapter:source0_data -> sw_pio_s1_agent:cp_data
	wire          sw_pio_s1_burst_adapter_source0_ready;                      // sw_pio_s1_agent:cp_ready -> sw_pio_s1_burst_adapter:source0_ready
	wire    [2:0] sw_pio_s1_burst_adapter_source0_channel;                    // sw_pio_s1_burst_adapter:source0_channel -> sw_pio_s1_agent:cp_channel
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (sw_pio_s1_agent_rdata_fifo_out_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (sw_pio_s1_agent_rdata_fifo_out_valid),                   //                .valid
		.rdata_fifo_sink_data    (sw_pio_s1_agent_rdata_fifo_out_data),                    //                .data
