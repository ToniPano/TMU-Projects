	soc_system u0 (
		...
		.div_control_0_div_control_d_start   (<connected-to-div_control_0_div_control_d_start>),   //   div_control_0_div_control.d_start
		.div_control_0_div_control_d_reset   (<connected-to-div_control_0_div_control_d_reset>),   //                            .d_reset
		.div_control_0_div_control_d_done    (<connected-to-div_control_0_div_control_d_done>),    //                            .d_done
		.div_data_0_div_data_d_denom         (<connected-to-div_data_0_div_data_d_denom>),         //         div_data_0_div_data.d_denom
		.div_data_0_div_data_d_numer         (<connected-to-div_data_0_div_data_d_numer>),         //                            .d_numer
		.div_data_0_div_data_d_quot          (<connected-to-div_data_0_div_data_d_quot>),          //                            .d_quot
		.div_data_0_div_data_d_rem           (<connected-to-div_data_0_div_data_d_rem>)            //                            .d_rem
	);
